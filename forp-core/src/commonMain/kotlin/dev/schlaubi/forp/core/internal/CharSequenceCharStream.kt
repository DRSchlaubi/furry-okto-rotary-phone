package dev.schlaubi.forp.core.internal
...
internal fun charStreamFromCharSequence(
    charSequence: CharSequence,
    sourceName: String = IntStream.UNKNOWN_SOURCE_NAME
): CharStream = CharSequenceCharStream(charSequence, sourceName)

private class CharSequenceCharStream(
...
internal fun CharSequence.codePointIndices(): IntArray {
